    ...
    <n-message-provider>
        ...
        >
            ...
            >
                ...
                <n-space>
                    <div>毅行活动是一项中高强度长距离的徒步活动，对参赛者身体状况有较高的要求，参赛者应身体健康。</div>
                ...
                <br />
                <n-space justify="center" style="font-size: large; font-weight: bold;">出发&行进&打卡须知</n-space>
                <n-space>
                    <div>1.毅行是一个团队协作的活动，请和队员以及其他团队之间互帮互助，团结合作，勿要走散；</div>
                    <div>2.队伍全部人员到齐之后才可以在打卡点打卡；各打卡点必须逐一盖章，不得跳盖；</div>
                    <div>3.每个打卡点都有关门时间，到达关门时间后不得前进，需从打卡点处的下撤点直接下山；</div>
                    <div>4.不在规定出发时间出发的团队不提供打卡单；</div>
                    <div>5.请妥善保存打卡单，最终结果以打卡单为准；</div>
                    <div>6.路线行至陡坡需有序通过；</div>
                    <div>7.毅行的过程当中，请不要在一个地点逗留太久，以免造成堵塞；</div>
                    <div>8.若存在小组成员退出，仅该小组其他成员完成全程，则该小组无法领取团体证书；</div>
                    <div>9.毅行途中请尽量避免与他人发生冲突，毅行不易，且行且珍惜。必要时请联系工作人员解决。</div>
                </n-space>

                <br />
                <n-space justify="center" style="font-size: large; font-weight: bold;">安全须知</n-space>
                <n-space>
                    <div>1.身体不适者请及时在指定位置下撤终止毅行或就近选择安全地点等待工作人员救助；</div>
                    <div>2.如果队伍中有人受伤需要立即联系身边最近的工作人员，原地等待医务人员救治，不要随意移动以免二次受伤；</div>
                    <div>3.禁止吸烟、明火，以防山火；</div>
                    <div>4.本次活动可能包括但不限于交通事故、摔伤、坠崖、溺水、低温、生物攻击等导致的伤害或者死亡的风险，请自行评估后再作是否参与本次活动的决定；</div>
                    <div>5.全程较长，请合理估计自己的身体状况，合理选择全程线或半程线路，如果发生体力不支等意外情况请及时联系工作人员下山，切勿逞能，以防发生危险。</div>
                </n-space>
